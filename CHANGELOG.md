...
- Stale Undo Follow referencing a superseded Follow no longer removes a re-subscribed instance; Undo must come from the stored subscriber actor and reference the currently stored Follow (matching id, and actor when present)
